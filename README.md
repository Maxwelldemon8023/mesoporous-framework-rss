...
这是一个面向介孔导电/共轭 MOF、COF、HOF、晶态多孔框架、介孔材料与自组装技术的个人学术 RSS。它每天从 OpenAlex 和 Crossref 检索北京时间昨日 00:00–23:59 发表的候选论文，跨来源去重、按研究相关性与期刊质量评分，再生成标准 RSS 2.0 日报。
...
- **拓展推荐**：任意 MOF、COF、HOF 等框架材料，高质量介孔材料论文，以及功能材料中的自组装、超分子组装、嵌段共聚物组装、胶体和界面组装技术；
- 核心推荐继续优先且不要求凑数；拓展推荐必须具有期刊质量、方法学价值或关注作者信号，每天最多 3 篇；
